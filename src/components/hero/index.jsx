    ...
    <div className="bg-dark flex justify-center overflow-hidden">
      <section className="bg-dark h-screen w-screen overflow-hidden lg:max-w-[1728px] responsive">
        ...
        <div className="background-hero h-screen flex xxxl:flex-col flex-wrap content-center justify-center xxxl:justify-start">
          <div className="mb-[100px] lg:my-auto xxxl:mb-[100px] xxxl:mt-0">
            <h1 className="text-center re-50 text-white text-6xl tracking-tight md:text-[100px] xxxl:text-[298px]">
              javier lekker
            </h1>
          ...
          <img
            src={heroImage}
            className="hidden lg:block lg:absolute lg:top-[350px] xxxl:max-w-[1300px] xxxl:absolute xxxl:top-[314px] xxxl:left-[16%]"
          />
        </div>
      </section>
    </div>
